...
export function loadConfig() {
  ...
  return {
    ...
    relayMaxSnapshots: asNumber(process.env.RELAY_MAX_SNAPSHOTS, 500),
    relayMaxSnapshotBytes: asNumber(process.env.RELAY_MAX_SNAPSHOT_BYTES, 2 * 1024 * 1024 * 1024),
    relayKeepPerConversation: asNumber(process.env.RELAY_KEEP_PER_CONVERSATION, 5),
